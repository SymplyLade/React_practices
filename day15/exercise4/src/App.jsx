...
function App() {
  const products = [
    { id: 1, name: "Stylish Shirt", price: 7000, img: "https://i.pinimg.com/736x/05/af/22/05af22c47dabc8f85d4e6def86f7ca54.jpg" },
    { id: 2, name: "Cool Jacket", price: 15000, img: "https://plus.unsplash.com/premium_photo-1671030274122-b6ac34f87b8b?w=500&autA%3D%3D" },
    { id: 3, name: "Sneakers", price: 25000, img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3MECkuP6PJuQ5fLfryCdXTulVfNzebx2V0Q&s" },
    { id: 4, name: "Jeans", price: 2000, img: "https://5.imimg.com/data5/DW/AP/TZ/SELLER-7318680/denim-jeans-1000x1000.jpg" },
    { id: 5, name: "Watch", price: 25000, img: "https://img.freepik.com/free-photo/stylish-golden-watch-white-surface_181624-27078.jpg?semt=ais_hybrid&w=740&q=80" },
    { id: 6, name: "Hat", price: 8500, img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBKpqPXHAUDCqbxOR9fjokM6c0XtnA4egJBw&s" },
  ];
  ...
  return (
    <div className="font-sans bg-gray-50 min-h-screen">
      ...
      <nav className="flex justify-between items-center p-5 bg-white shadow">
        <div className="text-2xl font-bold text-orange-500">Gbemisola</div>
      ...
      <footer className="p-6 bg-white shadow mt-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p>© 2025 Gbemisola. All rights reserved.</p>
